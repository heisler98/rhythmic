...
//  AudioPlayer1
//
//  Created by Hunter Eisler on 2/11/18.
...
// new audio manager to handle tracks, pans, playback, etc.
// be the model behind the V-C
...
class NewSessionTableViewController: UITableViewController {
    ...
    @IBAction func finishNewSession(_ sender: Any) {
    }
    
    @IBAction func cancelNewSession(_ sender: Any) {
    }
